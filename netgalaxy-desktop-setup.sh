...
echo
echo "➡️ Рестартирайте системата, след което при екрана за вход:"
echo "   🔹 Кликнете върху иконата на сесията до потребителското име"
echo "   🔹 Изберете 'Plasma (X11)' или 'KDE Plasma Workspace'"
echo "   🔹 Влезте в системата"
echo
echo "💡 Ако не виждате такъв избор, изпълнете следното в терминал:"
echo "   sudo dpkg-reconfigure sddm"
echo "   (След това рестартирайте отново)"
