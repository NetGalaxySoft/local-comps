...
show_help() {
  ...
  echo ""
  echo "Стартирайте скрипта без опции, за да започнете конфигурация."
}
...
set -e  # Прекратява при всяка грешка

# Път до SSH config файла
config_file="$HOME/.ssh/config"

# Проверка дали директорията ~/.ssh и файлът config съществуват и има правилни права
...
echo "======================================"
echo " ПРОГРАМА ЗА СЪЗДАВАНЕ НА SSH КЛЮЧОВЕ"
echo "======================================"
echo ""
echo ""
