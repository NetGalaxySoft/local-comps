...
echo "📌 Скриптът UniCyrl бе инсталиран успешно в:"
echo "    \$HOME/.local/bin/unicyrl.py"
echo ""

echo "🖥️ Автоматичното стартиране е конфигурирано чрез:"
echo "    \$HOME/.config/autostart/unicyrl.desktop"
echo ""

echo "🧪 За да направите проба:"
echo "    1. Уверете се, че скриптът работи (трябва да е стартиран автоматично)."
echo "    2. Отворете текстов редактор и напишете на QWERTY клавиатура:"
echo "       Dobrutro! Az pisha na qwerty bez da gleda klaviaturata."
echo "    3. Копирайте текста с Ctrl+C."
echo "    4. Поставете го с Ctrl+V – резултатът трябва да е автоматично кирилизиран:"
echo "       Добрутро! Аз пиша на куърти без да гледа клавиатурата."
echo ""

echo "ℹ️ Ако копираният текст не се трансформира:"
echo "    - Уверете се, че скриптът UniCyrl работи:"
echo "         ps aux | grep unicyrl.py"
echo "    - Ако не е активен, стартирайте го ръчно с:"
echo "         \$HOME/.local/bin/unicyrl.py &"
echo "    - Или рестартирайте компютъра, за да се активира автоматично."
echo ""
